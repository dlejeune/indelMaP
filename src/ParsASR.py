...
def get_arguments_from_CLI():
    ...
    parser.add_argument('--ancestral_reconstruction', '-asr', default=True, help = 'If set to true ancestral sites and evolutionary events are reconstructed.', required=False)
